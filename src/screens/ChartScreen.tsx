        ...
        <SafeAreaView edges={["bottom"]}>
          <View style={{ paddingHorizontal: 20, flexDirection: "row", paddingVertical: 10, borderTopWidth: 1, borderTopColor: Colors.lightgray }}>
            <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
              <TouchableOpacity><Feather name="bell" style={{ fontSize: 30 }} /></TouchableOpacity>
            </View>
            <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
              <Button textStyle={{ fontSize: 13 }}  style={{ paddingHorizontal: 30 }}>BUY</Button>
            </View>
            <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
              <Button textStyle={{ fontSize: 13 }}style={{ paddingHorizontal: 30 }}>SELL</Button>
            </View>
          </View>
        </SafeAreaView>
      </View>
